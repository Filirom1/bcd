...
from src.bcd_api.services.external import cover as cover_service
from src.bcd_api.services.external.cover import configure, download_cover
...
class TestCatalogServiceIntegration:
    ...
    def test_download_cover_delegates_to_cover_service(self, covers_dir):
        ...
        with patch("src.bcd_api.services.external.cover.download_cover") as mock_dl:
