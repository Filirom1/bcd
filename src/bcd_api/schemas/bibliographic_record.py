...
class BiblographicRecordBase(BaseModel):
    ...
    isbn: Optional[str] = Field(None, max_length=22, description="Identifier with prefix: isbn:NNNN for books, issn:NNNN-NNNX for periodicals")
    ...
    medium_type: str = Field(default="Livre", max_length=50, description="Medium type (any string: Livre, CD, DVD, Bande dessinée, etc.)")
    ...
    physical_size: Optional[str] = Field(None, max_length=100, description="Full physical description")
    cover_image: Optional[str] = Field(None, max_length=50, description="Local cover filename ({isbn}.jpg)")
