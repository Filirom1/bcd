        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <div class="card bg-light mt-3"><div class="card-body py-2">
                    ...
                    <span v-for="key in ['aut','aut1','aut3','ser','ser1','ser3','ill','ill1','ill3','tit','tit1','tit3','dewey']" :key="key" class="small text-muted d-block">{{ t('settings.rule_guide_' + key, { [key.toUpperCase()]: '{' + key.toUpperCase() + '}' }) }}</span>
                </div></div>
            </div>
        </div>
    `
